						...
						<div class="navi mt-1">
							<a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">{{$authUser ? $authUser['email'] : ''}}</span>
								</span>
							</a>
						</div>
					</div>
					...
					<span class="navi-item mt-2">
						<span class="navi-link">
							...
							<button type="submit" id="kt_login_signup_submit" 
								class="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6">Sign Out</button>
